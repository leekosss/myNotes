---
title: Java-day08 常用API
date: 2022-07-16 13:58:28
tags: Java
categories: Java
...
​	next() : 遇到了**空格**, 就不再录入数据了 , 结束标记: 空格, tab键
...
![1590939947722](Java-day08-常用API/1590939947722.png)
...
### 2.9 手机号屏蔽-字符串截取                  String  的    substring()  方法   截取字符串
...
public class Test5 {
    ...
    public static void main(String[] args) {
        ...
        // 2. 截取字符串前三位
        String start = telString.substring(0,3);   //不包括3这个位置
        // 3. 截取字符串后四位
        String end = telString.substring(7);  // 从下标为7开始截取
        // 4. 将截取后的两个字符串，中间加上****进行拼接，输出结果
