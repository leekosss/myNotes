...
==Request是请求对象，Response是响应对象。==这两个对象在我们使用Servlet的时候有看到：![1628735216156](Request-Response/1628735216156-1660564394474.png)

此时，我们就需要思考一个问题request和response这两个参数的作用是什么?

<!--more-->

![1628735746602](Request-Response/1628735746602-1660564394475.png)
...
![1628738273049](Request-Response/1628738273049-1660564394475.png)
...
![1628740441008](Request-Response/1628740441008-1660564394475.png)

从上图中可以看出，ServletRequest和HttpServletRequest都是Java提供的，所以我们可以打开JavaEE提供的API文档[参考: 资料/JavaEE7-api.chm],打开后可以看到:

![1628741839475](Request-Response/1628741839475-1660564394475.png)

所以ServletRequest和HttpServletRequest是继承关系，并且两个都是接口，接口是无法创建对象，这个时候就引发了下面这个问题:

![1628742224589](Request-Response/1628742224589-1660564394475.png)
...
![1628743040046](Request-Response/1628743040046-1660564394475.png)
...
![1628748240075](Request-Response/1628748240075-1660564394475.png)
...
![1628762794935](Request-Response/1628762794935-1660564394475.png)

#### 2.2.2 获取请求头数据

对于请求头的数据，格式为`key: value`如下:

![1628768652535](Request-Response/1628768652535-1660564394475.png)
...
![1628769145524](Request-Response/1628769145524-1660564394476.png)

#### 2.2.3 获取请求体数据

浏览器在发送GET请求的时候是没有请求体的，所以需要把请求方式变更为POST，请求体中的数据格式如下:

![1628768665185](Request-Response/1628768665185-1660564394476.png)
...
![1628770516387](Request-Response/1628770516387-1660564394476.png)

点击`提交`按钮后，就可以在控制台看到前端所发送的请求数据

![1628770585480](Request-Response/1628770585480-1660564394476.png)
...
![1628776252445](Request-Response/1628776252445-1660564394476.png)

* 如何解决上述重复代码的问题呢?

![1628776433318](Request-Response/1628776433318-1660564394476.png)
...
![1628778931277](Request-Response/1628778931277-1660564394476.png)

(2)把获取到的内容进行分割，内容如下:

![1628779067793](Request-Response/1628779067793-1660564394476.png)

(3)把分割后端数据，存入到一个Map集合中:

![1628779368501](Request-Response/1628779368501-1660564394476.png)
...
![1628780937599](Request-Response/1628780937599-1660564394476.png)
...
![1628780965283](Request-Response/1628780965283-1660564394476.png)
...
![1628781031437](Request-Response/1628781031437-1660564394476.png)
...
![1628781176434](Request-Response/1628781176434-1660564394476.png)
...
![1628781419752](Request-Response/1628781419752-1660564394477.png)

由于格式固定，所以我们可以使用IDEA提供的模板来制作一个Servlet的模板，这样我们后期在创建Servlet的时候就会更高效，具体如何实现:

(1)按照自己的需求，修改Servlet创建的模板内容

![1628781545912](Request-Response/1628781545912-1660564394477.png)

（2）使用servlet模板创建Servlet类

![1628782117420](Request-Response/1628782117420-1660564394477.png)
...
![1628784323297](Request-Response/1628784323297-1660564394477.png)

（4）查看控制台打印内容

![1628784356157](Request-Response/1628784356157-1660564394477.png)

（5）把req.html页面的请求方式改成post,再次发送请求和中文参数

![1628784425182](Request-Response/1628784425182-1660564394477.png)
...
1. 首先我们需要先分析下GET请求出现乱码的原因:
 ...
 ![1628829610823](Request-Response/1628829610823-1660564394477.png)
...
![1628833310473](Request-Response/1628833310473-1660564394477.png)

就可以获取张和三分别对应的10进制，然后在使用计算器，选择程序员模式，计算出对应的二进制数据结果:

![1628833496171](Request-Response/1628833496171-1660564394477.png)

在计算的十六进制结果中，每两位前面加一个%,就可以获取到`%E5%BC%A0%E4%B8%89`。

当然你从上面所提供的网站中就已经能看到编码16进制的结果了:

![1628833310473](Request-Response/1628833310474-1660564394477.png)
...
![1628846824194](Request-Response/1628846824194-1660564394477.png)
...
![1628849231208](Request-Response/1628849231208-1660564394477.png)
...
![1628851404283](Request-Response/1628851404283-1660564394477.png)
...
![1628854783523](Request-Response/1628854783523-1660564394477.png)
...
![1628855192876](Request-Response/1628855192876-1660564394477.png)
...
![1628856995417](Request-Response/1628856995417-1660564394478.png)
...
![1628857213364](Request-Response/1628857213364-1660564394478.png)
...
* 浏览器地址栏路径不发生变化
  ...
  ![1628857365153](Request-Response/1628857365153-1660564394478.png)
...
![1628857632899](Request-Response/1628857632899-1660564394478.png)
...
![1628857761317](Request-Response/1628857761317-1660564394478.png)
...
![1628858926498](Request-Response/1628858926498-1660564394478.png)
...
![1628859051368](Request-Response/1628859051368-1660564394478.png)
...
![1628859268095](Request-Response/1628859268095-1660564394478.png)
...
![1628859860279](Request-Response/1628859860279-1660564394478.png)
...
![1628861030429](Request-Response/1628861030429-1660564394478.png)
...
![1628861404699](Request-Response/1628861404699-1660564394478.png)
...
* 浏览器地址栏路径发送变化
  ...
  ![1628861893130](Request-Response/1628861893130-1660564394478.png)
...
![1628862170296](Request-Response/1628862170296-1660564394478.png)
...
![1628862652700](Request-Response/1628862652700-1660564394478.png)
...
![1628863270545](Request-Response/1628863270545-1660564394478.png)
...
![1628863905362](Request-Response/1628863905362-1660564394479.png)
...
![1628864140820](Request-Response/1628864140820-1660564394479.png)
...
![1628864390263](Request-Response/1628864390263-1660564394479.png)
...
![1628864883564](Request-Response/1628864883564-1660564394479.png)
...
![1628865728305](Request-Response/1628865728305-1660564394479.png)
...
![1628866248169](Request-Response/1628866248169-1660564394479.png)

2. 创建db1数据库，创建tb_user表，创建User实体类

2.1 将`资料\1. 登陆注册案例\2. MyBatis环境\tb_user.sql`中的sql语句执行下:

![1628866403891](Request-Response/1628866403891-1660564394479.png)

 2.2 将`资料\1. 登陆注册案例\2. MyBatis环境\User.java`拷贝到com.itheima.pojo

![1628866560738](Request-Response/1628866560738-1660564394479.png)
...
![1628867237329](Request-Response/1628867237329-1660564394479.png)
...
![1628867761245](Request-Response/1628867761245-1660564394479.png)

4.2 如果用户名和密码输入正确，则

![1628867801708](Request-Response/1628867801708-1660564394479.png)
...
![1628867904783](Request-Response/1628867904783-1660564394479.png)
