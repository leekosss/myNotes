...
![1630768703430](Maven高级/1630768703430.png)
...
![1630768869208](Maven高级/1630768869208.png)
...
![1630769969416](Maven高级/1630769969416.png)
...
![1630771178137](Maven高级/1630771178137.png)

##### 步骤2:项目中创建domain包

在`maven_03_pojo`项目中创建`com.itheima.domain`包，并将`maven_02_ssm`中Book类拷贝到该包中

![1630771371487](Maven高级/1630771371487.png)

##### 步骤3:删除原项目中的domain包

删除后，`maven_02_ssm`项目中用到`Book`的类中都会有红色提示，如下:

![1630771505703](Maven高级/1630771505703.png)
...
![1630771987325](Maven高级/1630771987325.png)
...
![1630773180969](Maven高级/1630773180969.png)

安装成功后，在对应的路径下就看到安装好的jar包

![1630773262441](Maven高级/1630773262441.png)
...
![1630773580067](Maven高级/1630773580067.png)

##### 步骤2:项目中创建dao包

在`maven_04_dao`项目中创建`com.itheima.dao`包，并将`maven_02_ssm`中BookDao类拷贝到该包中

![1630773695062](Maven高级/1630773695062.png)

在`maven_04_dao`中会有如下几个问题需要解决下:

![1630773958756](Maven高级/1630773958756.png)
...
![1630774696344](Maven高级/1630774696344.png)

再次对`maven_02_ssm`项目进行编译，又会报错，如下:

![1630774780211](Maven高级/1630774780211.png)
...
![1630774917743](Maven高级/1630774917743.png)

安装成功后，在对应的路径下就看到了安装好对应的jar包

![1630774946856](Maven高级/1630774946856.png)
...
![1630819455928](Maven高级/1630819455928.png)
...
![1630819768305](Maven高级/1630819768305.png)

在Dependencies中移除自己所添加`maven_03_pojo`依赖后，打开BookServiceImpl的类，你会发现Book类依然存在，可以被正常使用

![1630819826163](Maven高级/1630819826163.png)

这个特性其实就是我们要讲解的==依赖传递==。

依赖是具有传递性的:

![1630853726532](Maven高级/1630853726532.png)
...
![1630820964663](Maven高级/1630820964663.png)
...
![1630853443920](Maven高级/1630853443920.png)

如果想更全面的查看Maven中各个坐标的依赖关系，可以点击Maven面板中的`show Dependencies`

![1630853519736](Maven高级/1630853519736.png)
...
![1630854436435](Maven高级/1630854436435.png)
...
![1630854923484](Maven高级/1630854923484.png)
...
![1630858596147](Maven高级/1630858596147.png)
...
![1630859532119](Maven高级/1630859532119.png)
...
![1630859797123](Maven高级/1630859797123.png)
...
![1630860344968](Maven高级/1630860344968.png)
...
![1630944335419](Maven高级/1630944335419.png)
...
![1630946592924](Maven高级/1630946592924.png)

##### 步骤2:创建子项目

该项目可以被聚合工程管理，同时会继承父工程。

![1630947082716](Maven高级/1630947082716.png)
...
![1630947403475](Maven高级/1630947403475.png)
...
![1630947749661](Maven高级/1630947749661.png)
...
![1630977419627](Maven高级/1630977419627.png)
...
![1630977885030](Maven高级/1630977885030.png)
...
![1630948929828](Maven高级/1630948929828.png)
...
![1630981519370](Maven高级/1630981519370.png)

具体如何查看这些属性:

在cmd命令行中输入`mvn help:system`

![1630981585748](Maven高级/1630981585748.png)
...
![1630982018031](Maven高级/1630982018031.png)

这里面有两个单词，SNAPSHOT和RELEASE，它们所代表的含义是什么呢?

我们打开Maven仓库地址`https://mvnrepository.com/`

![1630983148662](Maven高级/1630983148662.png)
...
![1630983617755](Maven高级/1630983617755.png)
...
![1630983967960](Maven高级/1630983967960.png)

查看到的结果为:

![](Maven高级/1630977885030.png)
...
![1630985300814](Maven高级/1630985300814.png)
...
![1630985411766](Maven高级/1630985411766.png)
...
![1630986926124](Maven高级/1630986926124.png)
...
![1630987192620](Maven高级/1630987192620.png)
...
![1630988572349](Maven高级/1630988572349.png)

#### 步骤2:启动Nexus

![1630988673245](Maven高级/1630988673245.png)
...
![1630988939301](Maven高级/1630988939301.png)
...
![1630988857125](Maven高级/1630988857125.png)

#### 步骤4:首次登录重置密码

![1630988983159](Maven高级/1630988983159.png)

输入用户名和密码进行登录，登录成功后，出现如下页面

![1630989052183](Maven高级/1630989052183.png)

点击下一步，需要重新输入新密码，为了和后面的保持一致，密码修改为`admin`

![1630989094756](Maven高级/1630989094756.png)

设置是否运行匿名访问

![1630989122737](Maven高级/1630989122737.png)

点击完成

![1630989136097](Maven高级/1630989136097.png)
...
![1630989320979](Maven高级/1630989320979.png)
...
![1630990244010](Maven高级/1630990244010.png)
...
![1630990538229](Maven高级/1630990538229.png)

上面所说的这些内容，我们需要在本地Maven的配置文件`settings.xml`中进行配置。

#### 步骤1:私服上配置仓库

![1630991211000](Maven高级/1630991211000.png)
...
![1630991535107](Maven高级/1630991535107.png)
...
![1630992305191](Maven高级/1630992305191.png)
...
![1630992513299](Maven高级/1630992513299.png)

现在发布是在itheima-snapshot仓库中，如果想发布到itheima-release仓库中就需要将项目pom.xml中的version修改成RELEASE即可。

如果想删除已经上传的资源，可以在界面上进行删除操作:

![1630992952378](Maven高级/1630992952378.png)

如果私服中没有对应的jar，会去中央仓库下载，速度很慢。可以配置让私服去阿里云中下载依赖。

![1630993028454](Maven高级/1630993028454.png)
