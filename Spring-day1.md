...
* 从使用和占有率看
  ...
  * 所以说,Spring技术是JavaEE开发必备技能，企业开发技术选型命中率>==90%==
    ...
    ![image-20210729171139088](Spring-day1/image-20210729171139088.png)
...
* Spring发展到今天已经形成了一种开发的生态圈,Spring提供了若干个项目,每个项目用于完成特定的功能。
  ...
  * Spring有若干个项目，可以根据需要自行选择，把这些个项目组合起来，起了一个名称叫==全家桶==，如下图所示
    ...
    ![image-20210729171850181](Spring-day1/image-20210729171850181.png)
    ...
    **说明:**
    ...
    ![1629714811435](Spring-day1/1629714811435.png)
...
![image-20210729171926576](Spring-day1/image-20210729171926576.png)
...
* Spring Framework的发展也经历了很多版本的变更，每个版本都有相应的调整
  ...
  ![image-20210729172153796](Spring-day1/image-20210729172153796.png)

* Spring Framework的5版本目前没有最新的架构图，而最新的是4版本，所以接下来主要研究的是4的架构图

  ![1629720945720](Spring-day1/1629720945720.png)
...
![1629722300996](Spring-day1/1629722300996.png)
...
![1629723232339](Spring-day1/1629723232339.png)
...
![1629724206002](Spring-day1/1629724206002.png)
...
![1629735078619](Spring-day1/1629735078619.png)
...
![1629734010072](Spring-day1/1629734010072.png)
...
![1629734336440](Spring-day1/1629734336440.png)
...
![image-20210729184337603](Spring-day1/image-20210729184337603.png)
...
![1629736314989](Spring-day1/1629736314989.png)
...
![image-20210729183500978](Spring-day1/image-20210729183500978.png)
...
* 重新搭建一个新的案例环境,目的是方便大家查阅代码
  ...
  * 搭建的内容和前面的案例是一样的，内容如下：
    ...
    ![1629769227068](Spring-day1/1629769227068.png)
...
![image-20210729183558051](Spring-day1/image-20210729183558051.png)
...
* bean依赖注入的ref属性指定bean，必须在容器中存在
  ...
  ![1629771744003](Spring-day1/1629771744003.png)

* 如果不存在,则会报错，如下:

  ![1629771880920](Spring-day1/1629771880920.png)

  这个错误大家需要特别关注下:

  ![1629771972886](Spring-day1/1629771972886.png)
...
![image-20210729183628138](Spring-day1/image-20210729183628138.png)
...
* 打印，观察控制台的打印结果
  ...
  ![1629772538893](Spring-day1/1629772538893.png)
...
* 将scope设置为`prototype`
  ...
  ![1629772928714](Spring-day1/1629772928714.png)
...
![1631529887695](Spring-day1/1631529887695.png)
...
![1629775585694](Spring-day1/1629775585694.png)
...
![1629775972507](Spring-day1/1629775972507.png)
...
![1629776331499](Spring-day1/1629776331499.png)
...
![1629786862329](Spring-day1/1629786862329.png)
...
![image-20210729195248948](Spring-day1/image-20210729195248948.png)
...
![1629788036885](Spring-day1/1629788036885.png)
...
![1629788769436](Spring-day1/1629788769436.png)
...
* 调用对象中的方法来创建bean，对应的是第二行配置
  ...
  * factory-method:工厂对象中的具体创建对象的方法名,对应关系如下:
    ...
    ![image-20210729200203249](Spring-day1/image-20210729200203249.png)
...
![1629790070607](Spring-day1/1629790070607.png)
...
![1629790197860](Spring-day1/1629790197860.png)
...
![1629791473409](Spring-day1/1629791473409.png)
...
![1629792339889](Spring-day1/1629792339889.png)
...
* 运行程序，就能执行destroy方法的内容
  ...
  ![1629792857608](Spring-day1/1629792857608.png)
...
![1629794527419](Spring-day1/1629794527419.png)
...
* 思考:afterPropertiesSet和setBookDao谁先执行?
  ...
  * 重新运行AppForLifeCycle，打印结果如下:
    ...
    ![1629794928636](Spring-day1/1629794928636.png)
...
![1629799214191](Spring-day1/1629799214191.png)
...
![1629799873386](Spring-day1/1629799873386.png)
...
![1629800324721](Spring-day1/1629800324721.png)
...
![1629800748639](Spring-day1/1629800748639.png)
...
![1629802656916](Spring-day1/1629802656916.png)
...
![1629802697318](Spring-day1/1629802697318.png)
...
![1629803111769](Spring-day1/1629803111769.png)

上面已经完成了构造函数注入的基本使用，但是会存在一些问题:

![1629803529598](Spring-day1/1629803529598.png)
...
![1629805387647](Spring-day1/1629805387647.png)
...
* 按照名称注入中的名称指的是什么?
  ...
  ![1629806856156](Spring-day1/1629806856156.png)
...
![1629807579330](Spring-day1/1629807579330.png)
...
![1629808046783](Spring-day1/1629808046783.png)
